...
function Navbar() {
  ...
  return (
    <nav className="bg-zinc-50 dark:bg-[#a0a0cc] sticky top-0 shadow-xl z-[99999]">
      <div className="max-w-7xl py-2 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between py-2">
          ...
          <div className="hidden md:flex items-center">
            <Button
              onClick={openChat}
              className="text-white bg-gradient-to-br from-[#00b4d8] via-[#4361ee] to-[#023047] transition ease-in duration-200 delay-200"
            >
